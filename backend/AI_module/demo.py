# demo.py must in this folder, otherwise we can't load model (No module named 'models')
...
def caption_image_beam_search(encoder, decoder, image_path, word_map, beam_size=3):
    ...
    while True:
        ...
        # for the first step, 
        # all k points will have the same scores 
        ...
        next_word_inds = next_word_inds.int()
        prev_word_inds = prev_word_inds.int()
...
def visualize_att(image_path, seq, alphas, rev_word_map, smooth=True):
    ...
    out_name = "out_" + image_name.split(".")[0] + "." + image_name.split(".")[1]
